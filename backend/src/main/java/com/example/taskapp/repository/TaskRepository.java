...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    // 作成日順
    @Query("SELECT t FROM  Task t LEFT JOIN FETCH t.tag LEFT JOIN FETCH t.project " + 
    ...
    // プロジェクトのタスク
    @Query("SELECT t FROM Task t LEFT JOIN FETCH t.tag WHERE t.project.id = :projectId")
